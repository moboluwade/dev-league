...
const Impact = () => {
    return (
        <section className="text-black bg-white lg:px-[7.5rem] md:px-12 px-4 pb-12 flex flex-col">
                ...
                <ResponsiveMasonry columnsCountBreakPoints={{ 350: 1, 700: 2, 900: 3 }}>
                    <Masonry columnsCount={3}>
                        {demoImpactStories.map(story =>
                            <div className="w-auto p-6 mx-2 my-2 border rounded-lg m h-fit" key={story.id}>
                                <div className="w-fit">
