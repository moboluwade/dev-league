...
const SideNavbar = () => {
  return (
    <div className="w-96 bg-[#14171F]">
      <div className="flex flex-col ml-20 my-16 gap-6">
        ...
        <div className="text-[#FAFAF9] w-60 flex flex-wrap gap-x-6 gap-x-2 text-sm">
          <span>Terms of service</span>
          <span>Privacy</span>
          <span>Content Policy</span>
        </div>
        <div className="bg-[#FAFAF9] text-primary500 w-60 p-4 flex items-center justify-start gap-2 rounded-md text-xl cursor-pointer">
          <FaPlusCircle />
          <h2>New Blog</h2>
        </div>
      </div>
