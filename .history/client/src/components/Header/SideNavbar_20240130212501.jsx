  ...
  return (
    <div className="w-96 bg-[#14171F] h-[100vh]">
      <div className="flex flex-col items-center mx-auto mt-16 gap-6">
        ...
        <div className="flex flex-col items-center mt-8 text-small">
          <div className="flex items-center justify-between w-60 text-white p-4 gap-4 rounded-md text-xl cursor-pointer">
