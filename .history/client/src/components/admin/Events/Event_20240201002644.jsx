        ...
        <div className="flex gap-6 flex-col w-[52.95rem]">
          {eventsCard.map((card) => {
            return (
              <div
                key={card.id}
                className="py-4 px-2 md:px-6 border-2 rounded-md border-neutral400 flex gap-2 md:gap-4"
              >
                <div className="p-6 text-white flex items-center justify-center flex-col bg-primary500">
