    ...
    <div className="flex flex-col justify-start md:pl-8 md:pt-20">
      ...
      <div className="flex flex-col justify-center">
        <div className="flex flex-col pt-4">
          ...
          <input
            className="border-[1.5px] border-[#292422] placeholder:text-[#9F918B] pl-4 w-[36rem] h-10 outline-none rounded-md"
        ...
        <div className="flex flex-col pt-4">
          ...
          <input
            className="border-[1.5px] border-[#292422] placeholder:text-[#9F918B] pl-4 w-[36rem] placeholder:text-start h-24 outline-none rounded-md"
        ...
        <div className="flex flex-col pt-4">
          ...
          <div
            className="flex flex-row content-center border-[1.5px] border-[#292422] placeholder:text-[#9F918B] pl-4 py-4 w-[36rem] placeholder:text-start h-fit gap-6 outline-none rounded-md"
            name="event-location"
            id="event-location"
          >
