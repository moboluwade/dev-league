            ...
            <div className="px-1 md:px-3 py-1 rounded-full bg-error50 w-fit">
              {isEventOpen ? (
                ...
                <div className="flex flex-wrap items-center justify-center gap-1 md:gap-2 cursor-pointer">
                  <div className="rounded-full bg-primary700 px-2 text-white text-sm font-bold order-2 lg:order-1">
                    <p>Closed</p>
                  </div>
                  <p className="text-primary700 font-bold text-xs md:text-sm text-center">
