      ...
      <div className=" h-fit border-[1.5px] bg-[#E2DEDC] border-[#292422] rounded-md flex flex-row w-full max-w-[36rem]">
        <div className="bg-[#E2DEDC] placeholder:text-black placeholder:font-semibold pl-4 h-12 outline-none rounded-md w-[88%] flex flex-row items-center font-semibold">
          ...
          <input
            ...
            placeholder="20"
            onChange={(e) => {
              handleDateMonthChange(e.target.value);
            }}
          ...
          <input
            ...
            placeholder="24"
            onChange={(e) => {
              handleDateYearChange(e.target.value);
            }}
        ...
        <label
          onClick={handleCalendarStartClick}
          className="flex flex-col items-center justify-center w-6 px-6 border-l border-black"
          htmlFor="calendar"
        >
          <MarkCalendar />
        </label>
